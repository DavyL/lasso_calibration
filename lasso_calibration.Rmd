...
for(s in 1:length(prange)){#The extra parenthesis seem necessary 
...
plot(ratio_best_AIC, main = "performance of AIC compared to CV", ylab = "Avg number of times when AIC is best", xlab = "p")
plot(ratio_best_BIC, main = "performance of BIC compared to CV", ylab = "Avg number of times when BIC is best", xlab = "p")
