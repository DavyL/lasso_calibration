...
results_frame$AICc - min(results_frame$AICc)
results_frame$AICc - min(results_frame$AICc)
...
plot(x = results_frame$lambda, y = results_frame$AICc, type = "n", xlab = "lambda", ylab = "AICc(theta_lambda)") #type = "n" makes it so that we can add the axis after initialization
plot.xy(axis_lambda_cv, type = "l") #type = "l" to draw lines
...
plot(result_var_np$err_AIC, x = prange, main = "Avg l2 error", ylab = "Avg error", xlab = "p", type = "b")
...
points(y=varSigmaLowDim$dim_BIC, x=sigmarange, xlab="sigma2", ylab="estimated dimension", col = "red", type="b")
points(y=varSigmaLowDim$dim_CV, x=sigmarange, xlab="sigma2", ylab="estimated dimension", col = "green", type="b")
points(y=varSigmaLowDim$dim_true, x=sigmarange, xlab="sigma2", ylab="estimated dimension", col = "purple", type="p")
legend(x="topright", legend=c("AIC", "BIC", "CV", "true"), fill=c("skyblue", "red", "green", "purple"))

plot(y=varSigmaHighDim$dim_AIC, x=sigmarange, xlab="sigma2", ylab="estimated dimension", ylim = c(0,200), col = "skyblue", type="b")
points(y=varSigmaHighDim$dim_BIC, x=sigmarange, xlab="sigma2", ylab="estimated dimension", col = "red", type="b")
points(y=varSigmaHighDim$dim_CV, x=sigmarange, xlab="sigma2", ylab="estimated dimension", col = "green", type="b")
points(y=varSigmaHighDim$dim_true, x=sigmarange, xlab="sigma2", ylab="estimated dimension", col = "purple", type="p")
legend(x="topright", legend=c("AIC", "BIC", "CV", "true"), fill=c("skyblue", "red", "green", "purple"))
